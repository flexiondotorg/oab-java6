...
echo
echo "  1. `link "rraptorr/sun-java6" "https://github.com/rraptorr/sun-java6"`"
echo "  2. `link "rraptorr/oracle-java7" "https://github.com/rraptorr/oracle-java7"`"
echo
echo "This script is Based on the scirpt prepared by Martin Wimpress."
echo
echo "  1. `link "flexiondotorg/oab-java6" "https://github.com/flexiondotorg/oab-java6"`"
echo
...
point "Download the i586 and x64 Java install binaries from Oracle. Yes, `partial_em "both are required"`. (total 4 files)"
